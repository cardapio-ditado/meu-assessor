...
select t.id, x.code, x.official_name, x.domain, x.organ, x.sphere, x.record_types,
  ...
  (values
      ...
      ('F04', 'Diario Oficial de Varzea Grande', 'diariooficial.varzeagrande.mt.gov.br', 'Prefeitura Municipal de Varzea Grande', 'municipal', array['official_act','contract','amendment_act']::text[], 'document', false, array['PDF com texto NATIVO na edicao 539 (24 paginas, 20 mapas ToUnicode); OCR nao foi necessario','o numero da edicao NAO e unico: ha edicao normal e suplemento com o mesmo numero no mesmo dia','o nome do arquivo PDF nao segue a data; o endereco e lido da pagina da edicao','os atos de dentro da edicao (portarias, extratos) nao viram afirmacao: falta extrator de ato']::text[], 'access_probed'),
